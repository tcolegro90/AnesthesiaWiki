...
function updateAnatomicalDetailsVisibility() {
  ...
  // On mobile, update scroll lock based on whether any cascading dropdown is now open
  if (casePager && casePager.index === 6 &&
      window.matchMedia('(max-width: 820px)').matches &&
      window.location.protocol !== 'chrome-extension:') {
    const anyOpen = !!document.querySelector('.anat-dropdown.open');
