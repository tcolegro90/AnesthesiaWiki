    ...
    function showSavedPlanPicker(names, defaultPick, options) {
      ...
      return new Promise(function(resolve) {
        ...
        function _makeRow(name, isArchive, folderKey) {
          ...
          var _savedAtStr = (_savedAtD && !isNaN(_savedAtD.getTime()))
            ? _savedAtD.toLocaleDateString([], { month: 'numeric', day: 'numeric' }) + ' ' + _savedAtD.toLocaleTimeString([], { hour: 'numeric', minute: '2-digit' })
            : '';
          ...
          row.innerHTML =
            ...
            (_savedAtStr ? '<span class="spp-savedat"></span>' : '');
          ...
          var sa = row.querySelector('.spp-savedat');
          if (sa) sa.textContent = _savedAtStr;
          return row;
        }
