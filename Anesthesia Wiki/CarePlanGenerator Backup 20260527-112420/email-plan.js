...
/* global mirroredState, getState, buildPrintCard */
    ...
    function formatDateShort(dateStr) {
      ...
      var yy = m[3] ? (m[3].length === 2 ? '20' + m[3] : m[3]) : new Date().getFullYear();
      return mm + '-' + dd + '-' + yy;
    }
    ...
    async function emailCurrentPlan() {
      ...
      try {
        ...
        showTopbarFlash('PDF generation was unavailable — a text email draft was opened.');
        return;
      }
      ...
      showTopbarFlash('PDF downloaded. An email draft opened — please attach the downloaded PDF.');
    }
